...
/**
 * Preview sem autenticação dos avatares 3D reais. Mostra a separacao:
 ...
 * (AVATAR_KITS) e a matriz 4x7 completa. Guardado em produção.
 *
 * Query params: `?variant=` seleciona a identidade do strip de evolução;
 * `?fallback=1` força o AvatarFigure 2D (rollback).
 */
...
export default async function AvatarEvolutionPreviewPage({
  ...
  // Guardado em produção, EXCETO com ENABLE_PREVIEW_ROUTES=1 (env de runtime
    ...
    <div className="min-h-screen bg-[#070A12] text-white">
      <div className="container py-12 md:py-16">
        <span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/25 bg-cyan-300/10 px-4 py-1.5 text-sm font-medium text-cyan-100">
          ...
          Avatares 3D reais - identidade por GLB + evolução procedural
        </span>
        <h1 className="mt-5 max-w-3xl text-3xl font-bold tracking-tight md:text-4xl">
          4 identidades com GLB próprio, 8 estados com Evolution Kits.
        </h1>
        <p className="mt-3 max-w-3xl text-slate-300">
          ...
          <code className="text-cyan-200">/assets/3d</code>. A evolução por fase
          combina camadas procedurais (aura, aneis, partículas) com um{" "}
          <strong className="text-white">Evolution Kit</strong> modular por
          variante/fase: acessórios, placas, halos, badges e wireframes que se
        ...
        {/* Seção 1: identidades (1 GLB por variante, mesma fase). */}
            ...
            return (
              ...
              >
                ...
                <p className="text-[11px] text-slate-400">
                  {model ? model.url.split("/").pop() : "núcleo procedural"}
                </p>
        ...
        {/* Seção 2: evolução procedural da identidade selecionada. */}
        <div className="mt-12 flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-lg font-semibold text-white">
            Evolução por fase - {AVATAR_IDENTITIES[stripVariant].label}
          </h2>
        ...
        {/* Seção 3: matriz 4x8 (1 único canvas WebGL). */}
        <h2 className="mt-12 text-lg font-semibold text-white">
          Matriz 4 identidades x 8 estados
        </h2>
        <p className="mt-1 max-w-3xl text-sm text-slate-400">
          Visao completa num único contexto WebGL (28 canvases estourariam o
        ...
        <div className="mt-10 rounded-3xl border border-white/10 bg-white/[0.03] p-6 text-sm leading-6 text-slate-300">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              ...
              <code className="text-cyan-200">AVATAR_STATES</code> mantém as
            ...
            <li>
              ...
              núcleo procedural. Rollback por variante/fase: entrada{" "}
              ...
              <code className="text-cyan-200">?fallback=1</code> força o
              AvatarFigure 2D.
            </li>
            <li>
            ...
            <li>
              Ressalva de produção: Brasa, Verdejante e Nebulosa estão em
              otimizacao intermediaria (~1,5-2 MB, 37k-47k tris). Validos para
              preview; produção mobile exige nova passada no Blender
              (alvo 15k-30k tris).
            </li>
          </ul>
        </div>
